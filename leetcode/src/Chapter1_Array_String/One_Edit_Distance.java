 ...
 * 4. If m == n, it becomes finding if there is exactly one modified operation. If m ≠ n, you do not have to consider the delete operation. 
...
public class One_Edit_Distance {
	 ...
	 * Although this problem is solvable by directly applying the famous Edit distance dynamic programming algorithm with runtime complexity of O(mn) and 
	 * space complexity of O(mn) (could be optimized to O(min(m,n)), 
	 * it is far from desirable as there exists a simpler and more efficient one-pass algorithm.
	 * 
